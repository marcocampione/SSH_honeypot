 ...
 * ########### JSON LOG FILE ###########
 * TO FIX: 
 *  - Il file aggiunge solamente le informazione dell'utente che e' riuscito a loggarsi all'interno del sistema
 *  - Le informazioni nel file non vengono inserite nell'ordine in cui io ho scritto il codice   
 *  - Bisogna quindi implementare un logging che tenga traccia di tutti gli utenti che stanno provando ad accedere al servizio
 * 
...
/*
*######### GEOLOC IP USING GEOLITE2 DATABASE #########
*
*
// A File object pointing to your GeoIP2 or GeoLite2 database
File database = new File("C:\\Users\\marco\\Desktop\\TESI\\SSH_honeypot\\GeoLite2-City\\GeoLite2-City.mmdb");
